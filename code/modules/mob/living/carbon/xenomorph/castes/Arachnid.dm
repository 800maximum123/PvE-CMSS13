/datum/caste_datum/arachnid
	...
	caste_desc = "A four-legged arachnid warrior. The hive's primary active, numerous combat unit."
	tier = 2
...
/mob/living/carbon/xenomorph/arachnid
	...
	icon = 'icons/mob/arachnid/arachnid.dmi'
	...
	icon_xeno = 'icons/mob/arachnid/arachnid.dmi'
	icon_xenonid = 'icons/mob/arachnid/arachnid_green.dmi'
...
/mob/living/carbon/xenomorph/arachnid/handle_blood_splatter(splatter_dir)
	new /obj/effect/temp_visual/dir_setting/bloodsplatter/arachnidsplatter(loc, splatter_dir)
...
#undef ARACHNID_GRAB_CHANCE
#undef ARACHNID_NECKGRAB_CHANCE
#undef ARACHNID_HARM_PULL_CHANCE
