...
/datum/human_ai_spawner_menu/ui_static_data(mob/user)
	...
	data["selectable_factions"] = FACTION_LIST_HALO + FACTION_LIST_COVENANT + "Colonist" + "Zombie"
	data["equipment_settings"] = list("Full Equipment", "No Weapons", "Birthday Suit")
	data["species_settings"] = SYNTH_TYPES + SPECIES_HUMAN + SPECIES_ZOMBIE + SPECIES_SANGHEILI + SPECIES_UNGGOY + SPECIES_SPARTAN
	return data
