...
/obj/item/tape/random/lore
	name = "dusty tape"
	desc = "A dusty old tape, covered in cobwebs and dust."
	unacidable = TRUE
	flags_obj = NO_FLAGS

/obj/item/tape/random/lore/one
	storedinfo = list(
		"\[00:05] *лёгкий шум помех, затем уверенный голос*",
		"\[00:10] Eerie Voice says \"Добро пожаловать на объект добычи UNSC «Грейвлок-7»\"",
		"\[00:15] Eerie Voice says \"Если ты это слышишь - значит, ты теперь часть колонии.\"",
		"\[00:20] Eerie Voice says \"Здесь нет чужих. Здесь нет случайных людей.\"",
		"\[00:30] Eerie Voice says \"Здесь - только семья.\"",
		"\[00:35] Eerie Voice says \"Мы стоим на краю освоенного пространства\"",
		"\[00:40] Eerie Voice says \"Добываем металл, на котором держится флот\"",
		"\[00:45] Eerie Voice says \"Города...\"",
		"\[00:50] Eerie Voice says \"Каждый болт, каждый корпус корабля - начинается здесь. С нас.\"",
		"\[00:55] Eerie Voice says \"Работа тяжёлая. Воздух — не всегда чистый.\"",
		"\[01:00] Eerie Voice says \"Но рядом с тобой - те, кто прикроет спину в шахте и поднимет тебя, если ты упал.\"",
		"\[01:05] Eerie Voice says \"Помни: Мы не просто копаем породу - мы строим будущее человечества.\"",
		"\[01:10] Eerie Voice says \"Держись своих. Выполняй норму. И возвращайся живым в жилой сектор.\"",
		"\[01:15] Eerie Voice says \"Добро пожаловать домой, шахтёр.\"",
	)
	timestamp = list(
		50,
		100,
...
/obj/item/tape/random/lore/two
    storedinfo = list(
        "\[00:05] Unknown Voice says \"Странно, что в таком месте пошли сокращения по неизвестной причине...\"",
        "\[00:10] Unknown Voice says \"Просто средь белого дня некоторым из моих друзей пришли уведомления о том, что следующим рейсом их отправляют домой.\"",
        "\[00:15] Unknown Voice says \"Все они работали в новой ветке, которую недавно пробурили, правда не всех уволили, некоторые там остались.\"",
        "\[00:20] Unknown Voice says \"Не знаю, может вскрылось что сюда каким-то образом совсем юнцы пробрались, который толком не нюхали земли?\"",
        "\[00:30] Unknown Voice says \"В любом случае это странно, очень странно. Нам всегда нехватает рук на этой колонии.\"",
        "\[00:35] Unknown Voice says \"А такие внезапные сокращения вообще впервые тут!\"",
        "\[00:40] Unknown Voice says \"Может, они что-то там нашли и просто хотят прибрать к своим рукам?\"",
        "\[00:45] Unknown Voice says \"Но на такую глупость разве хватит мозгов у администрации, тут же даже целый корпус ККОН прикреплён, если даже очень захочется ты ничего отсюда не вынесешь.\"",
        "\[00:50] Unknown Voice says \"Надо бы действительно наведаться туда и узнать, в чём дело...\"",
    )
    timestamp = list(
        50,
        100,
...
/obj/item/tape/random/lore/three
    storedinfo = list(
        "\[00:05] Unknown Voice says \"Что будем делать с неопозанными сигналами в квадрате Е-6?\"",
        "\[00:10] Unknown Voice says \"Понятия не имею, директор сказал не вмешиваться туда, мол какой-то секретный обьект ККОН, связанный с разработками оружия\"",
        "\[00:15] Unknown Voice says \"По крайней мере он так сказал, каких либо документов подтверждающих это не было.\"",
        "\[00:20] Unknown Voice says \"Собственно, это не наши проблемы.\"",
        "\[00:30] Unknown Voice says \"Ты поймёшь цену всего этого потом, так что просто выполняй и дальше патрули и не задавай лишних вопросов.\"",
        "\[00:35] Unknown Voice says \"А если ты вздумаешь вмешаться, то ожидай последствий.\"",
        "\[00:40] Unknown Voice says \"...\"",
        "\[00:45] Unknown Voice says \"Тебя предупредили...\"",
    )
    timestamp = list(
        50,
        100,
