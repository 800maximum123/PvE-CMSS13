...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("arachnid_growl")
				sound = pick('sound/voice/arachnid_growl1.ogg','sound/voice/arachnid_growl2.ogg','sound/voice/arachnid_growl3.ogg')
			if("alien_hiss")
				sound = pick('sound/voice/alien_hiss1.ogg','sound/voice/alien_hiss2.ogg','sound/voice/alien_hiss3.ogg')
			if("arachnid_hiss")
				sound = pick('sound/voice/arachnid_hiss1.ogg','sound/voice/arachnid_hiss2.ogg','sound/voice/arachnid_hiss3.ogg')
			if("alien_tail_swipe")
			...
			if("arachnid_help")
				sound = pick('sound/voice/arachnid_help1.ogg','sound/voice/arachnid_help2.ogg','sound/voice/arachnid_help3.ogg')
			if("alien_drool")
			...
			if("arachnid_roar")
				sound = pick('sound/voice/arachnid_roar1.ogg','sound/voice/arachnid_roar2.ogg','sound/voice/arachnid_roar3.ogg')
			if("alien_roar_larva")
